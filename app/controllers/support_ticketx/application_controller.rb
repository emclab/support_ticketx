module SupportTicketx
  class SupportTicketx::ApplicationController < ::ApplicationController
    ...
    before_action :delete_session_variable, :only => [:create, :update]  #for parent_record_id & parent_resource in check_access_right
